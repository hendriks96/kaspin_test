    ...
    <header class="py-5 bg-light border-bottom mb-4">
        <div class="container">
            <div class="text-center my-5">
                ...
                <p class="lead mb-0">You logged in as admin. You can add, edit or delete product in this page</p>
            </div>
        </div>
    </header>
    <!-- Page content-->
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modal-delete" data-id="{{ $item->id }}">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('submit-items') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
        ...
        <div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('edit-items') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
        ...
        $(document).ready(function() {
            ...
            $('#modal-delete').on('show.bs.modal', event => {
                ...
                $('#btn-delete').on('click', function(){
                    window.location.href = `${baseUrl}/delete-items/${itemId}`;
                });
            });
